...
function generateReport() {
  function run(records) {
    ...
    var body = '<div class="print-header"><h1>FORMER REBELS DATABASE SYSTEM</h1><p>DASHBOARD SUMMARY REPORT</p><p>Generated: ' + printed + '</p><p>Generated by: ' + generatedBy + '</p></div>' +
